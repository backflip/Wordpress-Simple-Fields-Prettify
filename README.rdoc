...
* It fixes an issue with dragging field groups on the field group admin page (due to the jQuery UI sortable handle being placed outside draggable element, sorting was not possible in my case).
